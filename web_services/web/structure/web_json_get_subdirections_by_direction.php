<?php
	if($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		if(isset($_POST['direction_id'])){
			...
			get_activities($direction_id);
		}
	}

	function get_activities($direction_id){
		global $connect;
		$query = "select * FROM sys_structure_subdirections where direction_id = '$direction_id' and enabled = 1 order by subdirection";
